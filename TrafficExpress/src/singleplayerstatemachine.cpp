  ...
  for (int i = 0; i < m_perspectives.size(); i++) {
    for (int j = 0; j < m_perspectives.size(); j++) {
      if (i != j) {
        ...
        connect(m_perspectives[i], &PlayerPerspective::playerChoseWagon,
                m_perspectives[j], &PlayerPerspective::onPlayerChoseWagon);
        ;
      }
    }
...
int SinglePlayerStateMachine::size() { return m_perspectives.size(); }
...
void SinglePlayerStateMachine::push_back(PlayerPerspective *pp) {
  ...
  for (int i = 0; i < m_perspectives.size(); i++) {
    connect(m_perspectives[i], &PlayerPerspective::actionChangeWagonSignal, pp,
            &PlayerPerspective::onActionChangeWagonSignal);
    connect(pp, &PlayerPerspective::actionChangeWagonSignal, m_perspectives[i],
            &PlayerPerspective::onActionChangeWagonSignal);

    connect(m_perspectives[i], &PlayerPerspective::actionChangeFloorSignal, pp,
            &PlayerPerspective::onActionChangeFloorSignal);
    connect(pp, &PlayerPerspective::actionChangeFloorSignal, m_perspectives[i],
            &PlayerPerspective::onActionChangeFloorSignal);
    ...
    connect(m_perspectives[i], &PlayerPerspective::actionPunchSignal, pp,
            &PlayerPerspective::onActionPunchSignal);
    connect(pp, &PlayerPerspective::actionPunchSignal, m_perspectives[i],
            &PlayerPerspective::onActionPunchSignal);
    ...
    connect(m_perspectives[i], &PlayerPerspective::playerDrawCards, pp,
            &PlayerPerspective::onPlayerDrawCards);
    connect(pp, &PlayerPerspective::playerDrawCards, m_perspectives[i],
            &PlayerPerspective::onPlayerDrawCards);
  }
