...
// Constructors
ActionCard::ActionCard() : BanditCard(BanditType::BUSINESS_WOMAN) {}

ActionCard::ActionCard(ActionType action, BanditType bandit)
    : m_action(action), BanditCard(bandit) {}
...
// Get methods
ActionType ActionCard::action() const { return m_action; }

// Set methods
void ActionCard::setAction(ActionType newAction) { m_action = newAction; }
...
CardType ActionCard::Type() const { return CardType::ACTION_CARD; }

// GUI
void ActionCard::paint(QPainter *painter,
