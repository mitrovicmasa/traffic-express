...
BulletCard::BulletCard(BanditType bandit, unsigned numOfBullets)
    : BanditCard(bandit), m_numOfBullets(numOfBullets) {}
...
// Destructor
BulletCard::~BulletCard() = default;

// Get methods
const unsigned &BulletCard::numOfBullets() const { return m_numOfBullets; }
...
CardType BulletCard::Type() const { return CardType::BULLET_CARD; }

// GUI
void BulletCard::paint(QPainter *painter,
