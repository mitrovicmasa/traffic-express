...
void MainWindow::connectButtons() {
  connect(ui->pbGameRules, &QPushButton::clicked, this,
          &MainWindow::onGameRules);
  connect(ui->pbPlay, &QPushButton::clicked, this, &MainWindow::onPlay);
  connect(ui->pbQuit, &QPushButton::clicked, this, &QCoreApplication::quit);
  connect(ui->pbBackToMain, &QPushButton::clicked, this,
          &MainWindow::onBackToTheMenu);
  connect(ui->pbBackToMain_2, &QPushButton::clicked, this,
          &MainWindow::onBackToTheMenu);
  connect(ui->pbBackToMain_3, &QPushButton::clicked, this,
          &MainWindow::onBackToTheMenu);
  connect(ui->pbConnect, &QPushButton::clicked, this, &MainWindow::onConnect);
  connect(ui->pbReady, &QPushButton::clicked, this, &MainWindow::onReady);
...
void MainWindow::dialogInit() {
  ...
  setFont(font);
  connect(pbBackToMainMenu, &QPushButton::clicked, this,
          &MainWindow::onBackToTheMenu);
  pbBackToMainMenu->setStyleSheet(
      "border-image : url(://button.png); color: white; background: "
      "transparent;");
...
void MainWindow::setImages() {
  ui->labelTrafficExpress->setPixmap(QPixmap("://traffic_express.png")
                                         .scaled(QSize(350, 350),
                                                 Qt::IgnoreAspectRatio,
                                                 Qt::FastTransformation));
  ui->pbPlay->setStyleSheet(
      "border-image : url(://button.png); color: white; background: "
      "transparent;");
  ui->pbBackToMain->setStyleSheet(
      "border-image : url(://button.png); color: white; background: "
      "transparent;");
  ui->pbQuit->setStyleSheet(
      "border-image : url(://button.png); color: white; background: "
      "transparent;");
  ui->pbGameRules->setStyleSheet(
      "border-image : url(://button.png); color: white; background: "
      "transparent;");
  ui->pbConnect->setStyleSheet(
      "border-image : url(://button.png); color: white; background: "
      "transparent;");
  ui->pbBackToMain_2->setStyleSheet(
      "border-image : url(://button.png); color: white; background: "
      "transparent;");
  ui->pbBackToMain_3->setStyleSheet(
      "border-image : url(://button.png); color: white; background: "
      "transparent;");
  ui->pbConnect->setStyleSheet(
      "border-image : url(://button.png); color: white; background: "
...
void MainWindow::onChangeReadyColor(bool condition) {
  if (m_client->getReadys()[m_client->getIndex()]) {
    ui->pbReady->setStyleSheet(
        "border-image : url(://button_pink.png); color: white; background: "
        "transparent;");
  } else {
    ui->pbReady->setStyleSheet(
        "border-image : url(://button.png); color: white; background: "
...
void MainWindow::onChangeStartColor() {
  if (m_client->allReady() && m_client->getHost()) {
    ...
    ui->pbStart->setStyleSheet(
        "border-image : url(://button_dark.png); color: white; background: "
        "transparent;");
...
void MainWindow::onPlay() { ui->stackedWidget->setCurrentIndex(2); }

void MainWindow::onGameRules() { ui->stackedWidget->setCurrentIndex(1); }
...
void MainWindow::onConnect() {
  ...
  connect(this, &MainWindow::readyClicked, m_client,
          &PlayerClient::onClickedReady);
  connect(this, &MainWindow::startClicked, m_client,
          &PlayerClient::onClickedStart);

  connect(m_client, &PlayerClient::gameLoaded, this, &MainWindow::onGameLoaded);
  connect(m_client, &PlayerClient::changeReadyColor, this,
          &MainWindow::onChangeReadyColor);
  connect(m_client, &PlayerClient::changeStartColor, this,
          &MainWindow::onChangeStartColor);
